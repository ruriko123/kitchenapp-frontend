...
const RestaurantUpdateModal : FC < Props > = ({successToast, errorToast, reloadTable, restaurantData, closemodal}) => {
    ...
    const [isCloudKitchen,
        setisCloudKitchen] = useState(false);
    useEffect(() => {
        if (restaurantData) {
            setshow(true);
            ...
            setselectedoperatingLocation(restaurantData
                ?.operatingLocation);
            setisCloudKitchen(restaurantData
                ?.isCloudKitchen)
        };
    }, []);

    const changeisCloudKitchen = (e : any) => {
                ...
                <div
                    ...
                    <div className="d-flex justify-content-end m-2">
                        <input
                            ...
                            role="switch"
                            id="flexSwitchChecked"
                            defaultChecked={isCloudKitchen}
                            onClick={(e) => changeisCloudKitchen(e)}/>
                        <label
                            className="inline-block pl-[0.15rem] hover:cursor-pointer"
                            htmlFor="flexSwitchChecked">isCloudKitchen</label>
                    </div>
